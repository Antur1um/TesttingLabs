...
public class SearchPageObject extends MainPageObject {
    private static final String
            ...
            OVERFLOW_MENU = "//android.widget.ImageView[@content-desc=\"Ещё\"]",
    ...
    public void AndAddToList(String title) {
    ...
    public void viewListAndDeleteIt() {
        this.waitForElementAndClick(By.id(VIEW_LIST),
                "Невозможно нажать на 'Посмотреть список'",
                Duration.ofSeconds(15));
        this.waitForElementAndClick(By.xpath(OVERFLOW_MENU),
                "Невозможно нажать на кнопку 'Больше'",
                Duration.ofSeconds(15));
